  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
        ...
        className='relative bg-white p-10 rounded-xl text-slate-500'>
            ...
            {state !== 'Login' && <div className='border px-5 py-1 flex items-center gap-1 rounded-full mt-5'>
                <img className='w-7' src={assets.profile_icon} alt="" />
                <input onChange={e => setName(e.target.value)} value={name} type="text" className='outline-none text-sm' placeholder='FullName' required/>
            </div>}
